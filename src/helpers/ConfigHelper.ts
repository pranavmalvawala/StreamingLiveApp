...
export interface ConfigurationInterface { keyName?: string, churchId?: string, primaryColor?: string, primaryContrast?: string, logoImage?: string, buttons?: ButtonInterface[], tabs?: TabInterface[], services?: ServiceInterface[] }
