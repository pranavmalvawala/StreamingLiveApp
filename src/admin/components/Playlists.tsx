...
import { DisplayBox, ApiHelper, PlaylistInterface, UserHelper } from ".";
...
export const Playlists = (props: Props) => {
  ...
  const handleUpdated = () => { setCurrentPlaylist(null); loadData(); }
      ...
      rows.push(
        <tr key={playlist.id}>
          ...
          <td style={{ textAlign: "right" }}>
            <a href="about:blank" onClick={(e: React.MouseEvent) => { e.preventDefault(); setCurrentPlaylist(playlist); }}><Icon>edit</Icon></a>
          </td>
        </tr>
      );
      //idx++;
